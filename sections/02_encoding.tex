...
\noindent
The proposed signatures require an image construction whose components can be varied separately. We begin with the visible trace, define how each pen signal becomes colour, and then combine signals while keeping the rendering geometry fixed.
