...
\noindent
We assign one scalar signal to each RGB channel and evaluate all four subsets of size three. Table~\ref{tab:encoding} gives the assignments, and Figure~\ref{fig:progressive} illustrates the progression. All combinations use the same geometry, background and rendering settings as the static and isolated-signal images.
